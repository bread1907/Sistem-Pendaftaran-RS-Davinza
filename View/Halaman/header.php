...
<head>
  ...
  <style>
    :root { --primary: #0077C0; --text-secondary: #6B7280; }
  ...
  <div class="container py-3">
    ...
    <div class="collapse navbar-collapse" id="navMenu">
      ...
      <ul class="navbar-nav ms-4 gap-3">
        ...
        <li><a class="nav-link <?=($current=='pelayanan'?'nav-link-active':'nav-link-custom')?>" href="medical_services.html">Pelayanan</a></li>
        <li><a class="nav-link <?=($current=='finddoctor'?'nav-link-active':'nav-link-custom')?>" href="find_a_doctor.html">Temukan Dokter</a></li>
        <li><a class="nav-link <?=($current=='fasilitas'?'nav-link-active':'nav-link-custom')?>" href="patient_portal.html">Fasilitas</a></li>
        <li><a class="nav-link <?=($current=='janji'?'nav-link-active':'nav-link-custom')?>" href="jadwal_temu.php">Buat Janji Temu</a></li>
      ...
      <div class="d-none d-md-flex align-items-center gap-3 ms-auto">
        ...
        <?php else: ?>
          <!-- Jika sudah login: tampilkan username + logout dengan alert -->
